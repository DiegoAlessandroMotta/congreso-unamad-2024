    ...
    [
        {
          ...
          biografia:"Romario Díaz Holgado es un ingeniero de sistemas e informática con una sólida trayectoria en el ámbito de la tecnología y la innovación. Con experiencia en el manejo de bases de datos y servidores, así como en el desarrollo de aplicaciones utilizando lenguajes como Node.js, Go y GraphQL, Romario ha demostrado ser un profesional versátil y orientado a soluciones. Su capacidad para analizar, investigar e identificar problemáticas le permite brindar soluciones efectivas a desafíos complejos en diversas industrias. Romario se caracteriza por su excelente trabajo en equipo y su gran adaptabilidad al cambio, habilidades que ha cultivado a lo largo de su carrera. Comprometido con el aprendizaje continuo, Romario se entusiasma al explorar nuevas tecnologías y enfrentar retos que le permitan crecer profesionalmente. Su enfoque en la comunicación efectiva y la lectura rápida le han proporcionado una ventaja en la colaboración con colegas y la comprensión de tendencias emergentes en el campo de la informática. Romario Díaz Holgado es un profesional en constante evolución, dedicado a aplicar su conocimiento y habilidades para generar un impacto positivo en el ámbito tecnológico.",
        ...
        },
        {
          ...
          titlePonencia: "La inteligencia artificial en la mineria",
        ...
        },
        {
          ...
          biografia:'Luis Alberto Holgado Apaza es un destacado profesional en el ámbito de la informática, con un enfoque especial en la ciencia de datos y la inteligencia artificial. Es Ingeniero de Sistemas y cuenta con un Magíster y un Doctorado en Ciencias de la Computación de la Universidad Nacional del Altiplano de Puno. Su sólida formación académica ha sido fundamental en su desarrollo profesional, permitiéndole abordar desafíos complejos con un enfoque riguroso y analítico. A lo largo de su carrera, Luis ha acumulado una valiosa experiencia en el desarrollo de proyectos relacionados con la ciencia de datos, donde ha aplicado técnicas avanzadas para analizar y modelar información. Sus investigaciones han dado lugar a publicaciones en revistas especializadas, destacando su compromiso con la difusión del conocimiento y la innovación en su campo. En su ponencia titulada "Exploración de Predictores de la Satisfacción con la Vida de Docentes Peruanos a través de un Ensamble de Métodos de Selección de Características y Aprendizaje Automático", Luis abordará la importancia de identificar los factores que influyen en la satisfacción de los docentes, utilizando herramientas de aprendizaje automático. Su enfoque busca no solo comprender mejor la realidad de los educadores, sino también contribuir a la formulación de políticas y estrategias que mejoren su bienestar y calidad de vida. Luis Alberto Holgado Apaza es un referente en la intersección de la educación y la tecnología, y su trabajo continúa inspirando a aquellos que buscan aplicar la ciencia de datos para generar un impacto positivo en la sociedad.',
          titlePonencia: "Exploración de predictores de la satisfacción con la vida de docentes peruanos a través de un ensamble de métodos de selección de características y aprendizaje automático",
          estudio: "UNIVERSIDAD NACIONAL AMAZONÍCA DE MADRE DE DIÓS",
          estudioAbreviado: "UNAMAD",
          modalidad: 'Presencial',
          foto: holgado,
        ...
        },
        {
          ...
          gradoAcademico: "Maestro",
          biografia:'Jaffet Sillo Sosa es un destacado profesor e ingeniero con más de 20 años de experiencia en el ámbito académico y en instituciones de educación superior tecnológica. A lo largo de su carrera, ha desempeñado roles significativos, incluyendo coordinador académico, coordinador pedagógico, formador, asistente técnico y jefe de unidad, lo que refleja su compromiso constante con la excelencia en la educación. Con una sólida formación en investigación cuantitativa y estadística, Jaffet ha aportado su experiencia en áreas como informática y tecnologías de la información. Su trabajo se centra en el desempeño docente y académico, así como en el desarrollo de software y la didáctica de la matemática y lenguajes de programación. A lo largo de su carrera, ha estado involucrado en diversos proyectos que buscan mejorar la calidad educativa y la formación profesional de docentes y estudiantes. Su enfoque innovador y su capacidad para integrar tecnologías emergentes en el aula lo convierten en un referente en su campo. En su ponencia titulada "Modelo de Inteligencia Artificial para la Detección de Emociones", Jaffet explorará las aplicaciones de la inteligencia artificial para identificar y analizar emociones en diferentes contextos, un tema de creciente relevancia en la educación moderna. Su trabajo promete ofrecer valiosas herramientas para mejorar la interacción en el aula y apoyar el bienestar emocional de estudiantes y docentes.',
          titlePonencia: "Modelo de Inteligencia Artificial para la Detección de Emociones",
          estudio: "UNIVERSIDAD NACIONAL AMAZONÍCA DE MADRE DE DIÓS",
          estudioAbreviado: "UNAMAD",
          modalidad: 'Presencial',
          foto: sillo,
        ...
        },
        {
          ...
          gradoAcademico: "Ingeniero",
          biografia:"Honorario Apaza Alanoca es un destacado profesional en el ámbito de la inteligencia artificial y la tecnología. Actualmente, se desempeña como Revisor LQA Freelancer en Venga Global (San Francisco, EE. UU.), y es profesor extraordinario en la Universidad Nacional de Moquegua (Moquegua, Perú). Además, es Candidato a Magíster en Ciencias de la Computación en la Universidad Nacional de San Agustín de Arequipa (UNSA). Su labor investigativa se enfoca en la inteligencia artificial, siendo fundador del grupo de investigación AIMARA RG..",
