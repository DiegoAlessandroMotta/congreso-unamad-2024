...
export const data = [
  ...
  },
  {
    ...
    titlePonencia: "INGENIERÍA DE SOFTWARE: TENDENCIAS DE LAS METODOLOGÍAS ACTUALES",
    estudio: "Universidad Nacional Amazónica de Madre de Dios",
    estudioAbreviado: "UNAMAD",
    modalidad: 'Presencial',
    foto: dany ,
  ...
  },
  {
    ...
    titlePonencia: "ANÁLISIS DE PREDICTORES DE SATISFACCIÓN DE VIDA EN DOCENTES PERUANOS USANDO ENSAMBLE DE SELECCIÓN DE CARACTERÍSTICAS",
