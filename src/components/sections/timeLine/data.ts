export const data = [
  [
    ...
    {
      tituloPonencia:
        "Iot En El Contexto De Las Ciudades Inteligentes Y El Desarrollo Regional",
    ...
    {
      tituloPonencia:
        "Ingeniería De Software: Tendencias De Las Metodologías Actuales",
    ...
    {
      tituloPonencia:
        "Os Desafios Do Ensino, Pesquisa E Extensão Da Ciência Da Computação Na Amazônia",
  ...
  [
    ...
    {
      tituloPonencia:
        "Aplicaciones De La Inteligencia Artificial En La Minería Con Operaciones De Cielo Abierto: Un Enfoque Sistémico",
    ...
    {
      tituloPonencia:
        "Integración De Herramientas De IA En El Proceso De Enseñanza-Aprendizaje En Ingeniería De Sistemas",
    ...
    {
      tituloPonencia:
        "Detección Del Celo En Vacuno De Carne Usando Iot Y Aprendizaje Automatico",
